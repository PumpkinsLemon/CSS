...
__all__ = ['ResNet', 'resnet56', 'resnet110', 'wide_resnet20_8']
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=10, branch=3, zero_init_residual=False, 
        ...
        for i in range(branch):
            ...
            setattr(self, 'classifier3_' +str(i), nn.Linear(64 * block.expansion, num_classes * self.branch))
...
def resnet56(pretrained=False, path=None, **kwargs):
    ...
    model = ResNet(Bottleneck, [6, 6, 6], **kwargs)
    if pretrained:
...
def wide_resnet20_8(pretrained=False, path=None, **kwargs):
    ...
    """Constructs a Wide ResNet-20-8 model.
